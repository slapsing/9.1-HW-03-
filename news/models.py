...
class Author(models.Model):
    user = models.OneToOneField(
        ...
        primary_key=True,
        related_name='author'  # Доступ через user.author
    )
...
class Post(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE)  # связь «многие ко многим» с моделью Category
...
class Comment(models.Model):
    ...
    rating = models.FloatField(blank=True, null=True)  # рейтинг комментария.
